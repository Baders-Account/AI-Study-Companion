function developers(){
    ...
    const description ="This project explores XYZ. Replace this text with a concise explanation of your project's purpose, goals, and impact. Keep it to 3–6 sentences for readability."
    return(
