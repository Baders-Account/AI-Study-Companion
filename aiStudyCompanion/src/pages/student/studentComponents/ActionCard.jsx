...
function ActionCard(){
    ...
    return(
        <section className="relative flex flex-col flex-shrink  justify-around p-6 mt-15  border rounded-lg shadow-lg w-full min-h-64">

        <h1 className="absolute top-2 left-3 text-2xl font-bold">Actions</h1>
        
        <section className="flex flex-row flex-shrink justify-around  min-h-20">
